...
console.log(`The diet of the ${velociraptor.name} was ${velociraptor.diet}.`);
...
console.log(
  `The ${tyrannosaurus.name} lived in the ${tyrannosaurus.period} period.`
);
...
zooAnimals.forEach(function(currentValue) {
  animalNames.push(
    `Name: ${currentValue.animal_name}, scientific: ${
      currentValue.scientific_name
    }.`
  );
});
...
*/
const largerPopulation = zooAnimals.filter(function(currentValue) {
...
*/
const populationTotal = zooAnimals.reduce(function(it, array) {
  return it + array.population;
}, 0);
...
console.log(lowerCase);
const largerPopulation = zooAnimals.filter(currentValue => {
  return currentValue.population < 5;
});

console.log(largerPopulation);
const populationTotal = zooAnimals.reduce((it, array) => {
  return it + array.population;
}, 0);
console.log(populationTotal);
*/
